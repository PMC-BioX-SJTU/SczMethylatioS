...
def met_nor_result(all_data,trio_3_person_norm_index,outfile1,trio_3_person_fa_index,outfile2,trio_3_person_ma_index,outfile3,outfile4):
    ...
    normal_matrix = [[0 for col in range(27)]for row in range(252699)]
    normal_matrix[0][0]='111'
    normal_matrix[0][1]='110'
    normal_matrix[0][2]='11-1'
    normal_matrix[0][3]='101'
    normal_matrix[0][4]='100'
    normal_matrix[0][5]='10-1'
    normal_matrix[0][6]='1-11'
    normal_matrix[0][7]='1-10'
    normal_matrix[0][8]='1-1-1'
    normal_matrix[0][9]='011'
    normal_matrix[0][10]='010'
    normal_matrix[0][11]='01-1'
    normal_matrix[0][12]='001'
    normal_matrix[0][13]='000'
    normal_matrix[0][14]='00-1'
    normal_matrix[0][15]='0-11'
    normal_matrix[0][16]='0-10'
    normal_matrix[0][17]='0-1-1'
    normal_matrix[0][18]='-111'
    normal_matrix[0][19]='-110'
    normal_matrix[0][20]='-11-1'
    normal_matrix[0][21]='-101'
    normal_matrix[0][22]='-100'
    normal_matrix[0][23]='-10-1'
    normal_matrix[0][24]='-1-11'
    normal_matrix[0][25]='-1-10'
    normal_matrix[0][26]='-1-1-1'
    ...
    for line in islice(all_data,2,None):
        ...
        for i in range(0,len(trio_3_person_norm_index),3):
          ...
          mode=line[trio_3_person_norm_index[i]]+line[trio_3_person_norm_index[i+1]]+line[trio_3_person_norm_index[i+2]]
    ...
    all_data.close()
    outfile_norm.close()
    return normal_matrix,all_modes
...
def figure(met_result_matrix,all_modes):
    ...
    plt.ylabel("Count")
    plt.title("Trio (Normal)")
  
    plt.show()  
    plt.savefig("Normal_all_modes_bar.jpg",dpi=300)
    plt.savefig("Normal_all_modes_bar.pdf", bbox_inches='tight')
